...
public class ImageToZPL {
	...
	public static void main(String[] args) {
        try {
            // Load an image from file (replace "path/to/your/image.jpg" with your file path)
            BufferedImage originalImage = ImageIO.read(new File("input_image.png"));
            
            ImageToZPL imageToZPL = new ImageToZPL();
            imageToZPL.init();
            
            // Convert the image to ZPL code with header and footer
            String zplCode = ImageToZPL.getZplCode(originalImage, true);

            // Print the generated ZPL code
            System.out.println("Generated ZPL Code:\n" + zplCode);
	...
	public static String getZplCode(BufferedImage bufferedImage, Boolean addHeaderFooter) {
		ImageToZPL zp = new ImageToZPL();
		zp.setCompressHex(true);
		zp.setBlacknessLimitPercentage(50);
		BufferedImage grayBitmap = toGrayScale(bufferedImage);
	...
	public static BufferedImage toGrayScale(BufferedImage bufferedImage) {
		...
		// Use ColorConvertOp to convert the image to grayscale
		ColorConvertOp op = new ColorConvertOp(ColorModel.getRGBdefault().getColorSpace(),
	...
	public String convertFromImage(BufferedImage image, Boolean addHeaderFooter) {
	...
	private String createBody(BufferedImage bitmapImage) {
